...
#     df.loc[df['athlete_id'] == athlete,'cumulative_{0}'.format('distance')] = cumulative(df, 'athlete_id', 'distance', 'start_date_local')
#     df.loc[df['athlete_id'] == athlete,'cumulative_{0}'.format('total_elevation_gain')] = cumulative(df, 'athlete_id', 'total_elevation_gain', 'start_date_local')
#     df.loc[df['athlete_id'] == athlete,'cumulative_{0}'.format('moving_time')] = cumulative(df, 'athlete_id', 'moving_time', 'start_date_local')    
